          ...
          <td>
          	<div class="button-group">
				<a class="button border-main" href="javascript:void(0)" onclick="xiugai(this)">
					...
					<a style="display: none" class="button border-save" href="javascript:void(0)" onclick="baocun(this)">
...
function baocun(a){
	...
	var spec = $tr.children("td:eq(3)").children("input").val();
	var price = $tr.children("td:eq(4)").children("input").val();
	var amount = $tr.children("td:eq(5)").children("input").val();
	
	var param = {"goodsid":goodsid,"name":name,"spec":spec,"price":price,"amount":amount};
...
function xiugai(a){
 ...
 var $td4 = $($tr.children("td")[3]);
 var $td5 = $($tr.children("td")[4]);
 var $td6 = $($tr.children("td")[5]);
